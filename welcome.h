...
printf(COLOUR_GREEN"Your %s is running iOS %s, press enter to continue or control + c if this is inaccurate \n %s", [deviceModel UTF8String], [systemVersion UTF8String], COLOUR_RESET);
return 0; 
}