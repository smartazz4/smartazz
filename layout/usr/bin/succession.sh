...
mkdir -p /private/var/mobile/Media/Succession/ >> $SetLogLocation
curl --silent https://raw.githubusercontent.com/Samgisaninja/samgisaninja.github.io/master/motd-cli.plist -o /private/var/mobile/Media/Succession/motd.plist -k >> $SetLogLocation
